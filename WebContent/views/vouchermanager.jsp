...
<script src="js/vouchermanager.js" type="text/javascript" charset="utf-8"></script>
	...
	<section id="voucher_show">
		...
		<nav id="nav_operation">
			<div id="div_operation">
				<button type="button" id="btn_updateVoucher" class="whiteButton">修改凭证</button>
				<button type="button" id="btn_addVoucher" class="whiteButton">增加凭证</button>
				<button type="button" id="btn_deleteVoucher" class="whiteButton">凭证删除</button>
			</div>
			<div id="div_page">
				当前页数：
	...
	<section id="voucher_add" hidden style="width: 500px; margin: 10px auto">
		<form action="" method="post" id="addAndUpdateForm">
			<fieldset id="" style="border: 0px">
				...
				<td><input type="text" name="voucherno" id="voucherno" value=""></td>
				<td><label id="labeltip_voucherno" style="color:red">请输入凭证编号</label></td>
				</tr>
				<tr id="tr_type">
				<td><label for="type">凭证类型：</label></td>
				<td><input type="text" name="type" id="type" value=""><br></td>
				<td><label id="labeltip_type"></label></td>
				</tr>
				<tr id="tr_occurtime">
				<td><label for="occurtime">凭证时间：</label></td>
				<td><input type="text" name="occurtime" id="occurtime" value=""></td>
				</tr>
				<tr id="tr_weight">
				<td><label for="weight">商品重量：</label></td>
				<td><input type="text" name="weight" id="weight" value=""><br></td>
				<td><label id="labeltip_weight"></label></td>
				</tr>		
				<tr id="tr_totalprice">
				<td><label for="totalprice">商品价格：</label></td>
				<td><input type="text" name="totalprice" id="totalprice" value=""><br></td>
				<td><label id="labeltip_totalprice"></label></td>
				</tr>
				<tr id="tr_materialname">
				<td><label for="materialid">原料名称：</label></td>
				<td><input type="text" name="materialname" id="materialname" value=""><br></td>
				...
				<td><input type="text" name="bususername" id="bususername" value=""><br></td>
				<td><label id="labeltip_bususername"></label></td>
				</tr>
				<tr id="tr_storeusername">
				<td><label for="storeusername">仓库管理：</label></td>
				<td><input type="text" name="storeusername" id="storeusername" value=""><br></td>
